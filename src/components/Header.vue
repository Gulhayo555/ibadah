    ...
    >
      <SplideSlide>
        <div class="item">
            ...
            <div class="row title">
              <div class="col-lg-6">
                <div class="hero-text">
                  ...
                  <a href="#!" class="hero_btn">Discover Courses</a>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="hero-img">
          ...
          <img class="item_img" src="../assets/images/hero-img.jpg" alt="" />
        </div>
      </SplideSlide>
      <SplideSlide>
        <div class="item">
          ...
          <img
            class="item_img"
            src="../assets/images/hero-img-back-1.jpg"
            alt=""
          />
        </div>
      </SplideSlide>
      <SplideSlide>
        <div class="item">
          ...
          <img
            class="item_img"
            src="../assets/images/hero-img-back-2.jpg"
            alt=""
          />
        </div>
